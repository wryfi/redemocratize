...
The only time the American people achieved a fundamental revision to the
architecture of their government, the alterations were written in the blood of
a civil war.
...
equal," and then enacted a social contract that counted enslaved human beings
as three-fifths of a person to amplify the political power of the states that
enslaved them. This was not hypocrisy in the ordinary sense. It was a
structural contradiction written into the architecture of the republic, a
system premised on the consent of the governed that granted governing power in
...
reality was clear: the judiciary has no enforcement mechanism independent of
